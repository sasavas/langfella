...
export class AuthService {
    private registerlink = "https://aldaci-langfella-api.azurewebsites.net/Users/register";
    private loginlink = "https://aldaci-langfella-api.azurewebsites.net/Users/login";
    ...
    login(email: string, password: string){
        return this.http.post<any>(this.loginlink, {
            email: email,
            password: password,
        }).pipe(
            tap(response => {
